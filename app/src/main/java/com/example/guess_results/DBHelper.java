...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public long insertModule(Module module) {
        ...
        contentValues.put(COLUMN_COEF, module.getCoef());
        contentValues.put(COLUMN_EVAL, module.getEval());
        contentValues.put(COLUMN_EVAL_PERC, module.getEvalPerc());
        contentValues.put(COLUMN_EXAM, module.getExam());
        contentValues.put(COLUMN_EXAM_PERC, module.getExamPerc());
